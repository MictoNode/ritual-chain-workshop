      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        <section className="mb-6">
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-400">
            Commit a hidden answer, reveal it after the submission deadline, then Ritual AI ranks
            every revealed answer in one batch. The bounty owner finalizes the winner.
          </p>
          <div className="mt-3 flex flex-wrap gap-2 text-xs text-zinc-400">
            ...
            <span className="rounded-full bg-white/5 px-3 py-1 ring-1 ring-inset ring-white/10">
              Answers stay hidden until the reveal deadline.
            </span>
            <span className="rounded-full bg-white/5 px-3 py-1 ring-1 ring-inset ring-white/10">
